...
- bisac_categories: 2-3 BISAC codes ('JUVENILE FICTION / Animals / Bears',
  'FICTION / Fantasy / Epic', etc). Use the standard hierarchy.
...
def _build_user_prompt(*, concept: IBookConcept, bible: IBookBible, author: str) -> str:
...
async def generate_metadata(
    *,
    ...
    user_prompt = _build_user_prompt(concept=concept, bible=bible, author=author)
